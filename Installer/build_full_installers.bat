...
makensis.exe /DNAME=%_name% /DCAPTION=%_name% /DOUTPUTFILE=%_output% /DVERSION=%_version% /DVERSION_FULL=%_version_full% /DARCH=x86 /DSOURCE2006 /DSOURCE2007 -V3 SourceSDKBaseResources.nsi
